...
export default function Retrospective() {
    ...
    if (loading) {
        return <div className="flex items-center justify-center h-full text-slate-800">Loading sprint data...</div>;
    }
        ...
        <div className="max-w-6xl mx-auto p-6">
            ...
            {step === 'dashboard' && stats && (
                <div className="space-y-8 animate-fade-in">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-slate-500 mt-2">Review your {stats.sprint_days}-day sprint performance</p>
                    </div>
            ...
            {step === 'feedback' && (
                <div className="space-y-8 max-w-2xl mx-auto animate-fade-in">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-slate-500 mt-2">Reflect on your sprint experience</p>
                    </div>
            ...
            {step === 'done' && (
                <div className="space-y-8 animate-fade-in text-center max-w-2xl mx-auto">
                    ...
                    <div>
                        <h1 className="text-5xl font-extrabold text-slate-900 mb-4">Sprint Complete!</h1>
                        <p className="text-2xl text-slate-500">Great job on completing your sprint.</p>
                    </div>
